...
[
	...
	["Sting SMG", "SMG_02_F", 600],
	["Vermin SMG", "SMG_01_F", 800]
];
...
[
	...
	["Mk20 Carbine (Camo)", "arifle_Mk20C_F", 1600],
	["Mk20 Rifle", "arifle_Mk20_plain_F", 1500],
	["Mk20 Rifle (Camo)", "arifle_Mk20_F", 1600],
	["Mk20 EGLM Rifle", "arifle_Mk20_GL_plain_F", 1800],
	["Mk20 EGLM Rifle (Camo)", "arifle_Mk20_GL_F", 1900],

	["TRG-20 Carbine", "arifle_TRG20_F", 1500],
	["TRG-21 Rifle ", "arifle_TRG21_F", 1500],
	["TRG-21 EGLM Rifle", "arifle_TRG21_GL_F", 1800],

	["Katiba Carbine", "arifle_Katiba_C_F", 2500],
	["Katiba Rifle", "arifle_Katiba_F", 2500],
	["Katiba GL Rifle", "arifle_Katiba_GL_F", 2800],

	["MX Carbine", "arifle_MXC_F", 2800],
	["MX Carbine (Black)", "arifle_MXC_Black_F", 2900],
	["MX Rifle", "arifle_MX_F", 2800],
	["MX Rifle (Black)", "arifle_MX_Black_F", 2900],
	["MX 3GL Rifle", "arifle_MX_GL_F", 3000],
	["MX 3GL Rifle (Black)", "arifle_MX_GL_Black_F", 3100],

	// Markman Rifles
	["MXM Rifle", "arifle_MXM_F", 3000],
	["MXM Rifle (Black)", "arifle_MXM_Black_F", 3100],
	["DMR Rifle", "srifle_DMR_01_F", 3500],
	["Mk18 ABR Rifle", "srifle_EBR_F", 4500],

	// Sniper Rifles
	["M320 LRR Sniper", "srifle_LRR_SOS_F", 15000],
	["M320 LRR Sniper (Camo)", "srifle_LRR_camo_SOS_F", 16000],
	["GM6 Lynx Sniper", "srifle_GM6_SOS_F", 18000],
	["GM6 Lynx Sniper (camo)", "srifle_GM6_camo_SOS_F", 19000]
];

lmgArray = compileFinal str
[
	["MX SW LMG", "arifle_MX_SW_F", 4000],
	["MX SW LMG (Black)", "arifle_MX_SW_Black_F", 4100],
	["Mk200 LMG", "LMG_Mk200_F", 5000],
	["Zafir LMG", "LMG_Zafir_F", 8000]
];
...
[
	...
	["Titan MPRL Compact (Tan)", "launch_Titan_short_F", 12000],
	["Titan MPRL Compact (Brown)", "launch_O_Titan_short_F", 12000],
	["Titan MPRL Compact (Olive)", "launch_I_Titan_short_F", 12000],
	["Titan MPRL AA (Desert)", "launch_Titan_F", 15000],
	["Titan MPRL AA (Hex)", "launch_O_Titan_F", 15000],
	["Titan MPRL AA (Digi)", "launch_I_Titan_F", 15000]
];
...
[
	...
	["Static Titan AT 4Rnd (NATO)", "B_static_AT_F", 8000], // Static launchers only have 4 ammo, hence the low price
	["Static Titan AT 4Rnd (CSAT)", "O_static_AT_F", 8000],
	["Static Titan AT 4Rnd (AAF)", "I_static_AT_F", 8000],
	...
	["Mk30 HMG .50 Low tripod (CSAT)", "O_HMG_01_F", 6000],
	["Mk30 HMG .50 Low tripod (AAF)", "I_HMG_01_F", 6000],
	...
	["Mk30 HMG .50 High tripod (NATO)", "B_HMG_01_high_F", 8000],
	["Mk30 HMG .50 High tripod (CSAT)", "O_HMG_01_high_F", 8000],
	["Mk30 HMG .50 High tripod (AAF)", "I_HMG_01_high_F", 8000],
	["Mk32 GMG 20mm Low tripod (NATO)", "B_GMG_01_F", 12000],
	["Mk32 GMG 20mm Low tripod (CSAT)", "O_GMG_01_F", 12000],
	["Mk32 GMG 20mm Low tripod (AAF)", "I_GMG_01_F", 12000],
	// ["Mk32A GMG 20mm Sentry (NATO)", "B_GMG_01_A_F", 1000],
	// ["Mk32A GMG 20mm Sentry (CSAT)", "O_GMG_01_A_F", 8000],
	// ["Mk32A GMG 20mm Sentry (AAF)", "I_GMG_01_A_F", 8000],
	["Mk32 GMG 20mm High tripod (NATO)", "B_GMG_01_high_F", 15000],
	["Mk32 GMG 20mm High tripod (CSAT)", "O_GMG_01_high_F", 15000],
	["Mk32 GMG 20mm High tripod (AAF)", "I_GMG_01_high_F", 15000],
...
[
	...
	["APERS Bounding Mine", "APERSBoundingMine_Range_Mag", 300],
	["APERS Mine", "APERSMine_Range_Mag", 350],
...
[
	...
	["6.5mm 100Rnd Tracer (Red) Belt Case", "100Rnd_65x39_caseless_mag_Tracer", 650],
	["6.5mm 200Rnd Belt Case", "200Rnd_65x39_cased_Box", 850],
	["6.5mm 200Rnd Tracer (Yellow) Belt Case", "200Rnd_65x39_cased_Box_Tracer", 750],
	["7.62mm 10Rnd Mag", "10Rnd_762x51_Mag", 200],
	["7.62mm 20Rnd Mag", "20Rnd_762x51_Mag", 250],
	["7.62mm 150Rnd Box", "150Rnd_762x51_Box", 950],
	["7.62mm 150Rnd Tracer (Green) Box", "150Rnd_762x51_Box_Tracer", 850],
	[".408 7Rnd Cheetah Mag", "7Rnd_408_Mag", 400],
	...
	["PCML Anti-Tank Missile", "NLAW_F", 3000],                // Direct damage: very high | Splash damage: low    | Guidance: laser, ground vehicles
	...
	["40mm HE Grenade Round", "1Rnd_HE_Grenade_shell", 600],
	["40mm 3Rnd HE Grenades", "3Rnd_HE_Grenade_shell", 800],
	["40mm Smoke Round (White)", "1Rnd_Smoke_Grenade_shell", 250],
	["40mm Smoke Round (Purple)", "1Rnd_SmokePurple_Grenade_shell", 250],
	["40mm Smoke Round (Blue)", "1Rnd_SmokeBlue_Grenade_shell", 250],
	["40mm Smoke Round (Green)", "1Rnd_SmokeGreen_Grenade_shell", 250],
	["40mm Smoke Round (Yellow)", "1Rnd_SmokeYellow_Grenade_shell", 250],
	["40mm Smoke Round (Orange)", "1Rnd_SmokeOrange_Grenade_shell", 250],
	["40mm Smoke Round (Red)", "1Rnd_SmokeRed_Grenade_shell", 250],
	...
	["40mm 3Rnd Smokes (Red)", "3Rnd_SmokeRed_Grenade_shell", 600],
	["40mm Flare Round (White)", "UGL_FlareWhite_F", 600],
	["40mm Flare Round (Green)", "UGL_FlareGreen_F", 600],
	["40mm Flare Round (Yellow)", "UGL_FlareYellow_F", 600],
	["40mm Flare Round (Red)", "UGL_FlareRed_F", 600],
	["40mm Flare Round (IR)", "UGL_FlareCIR_F", 600],
...
[
	...
	["Suppressor .45 ACP", "muzzle_snds_acp", 600, "item"],
	["Suppressor 5.56mm", "muzzle_snds_M", 800, "item"],
	["Suppressor 6.5mm", "muzzle_snds_H", 1000, "item"],
	["Suppressor 6.5mm LMG", "muzzle_snds_H_MG", 1200, "item"],
	["Suppressor 7.62mm", "muzzle_snds_B", 1500, "item"],
	["Flashlight", "acc_flashlight", 200, "item"],
	["IR Laser Pointer", "acc_pointer_IR", 200, "item"],
	["Yorris Sight (Zubr Revolver)", "optic_Yorris", 300, "item"],
	["MRD Sight (4-Five Pistol)", "optic_MRD", 300, "item"],
...
[
	...
	["SF Helmet", "H_HelmetSpecB", 150, "hat"],
	["SF Helmet (Black)", "H_HelmetSpecB_blk", 150, "hat"],
	["SF Helmet (Light Paint)", "H_HelmetSpecB_paint1", 150, "hat"],
	["SF Helmet (Dark Paint)", "H_HelmetSpecB_paint2", 150, "hat"],
	...
	["Heli Crew Helmet (NATO)", "H_CrewHelmetHeli_B", 100, "hat"],
	["Heli Crew Helmet (CSAT)", "H_CrewHelmetHeli_O", 100, "hat"],
	["Heli Crew Helmet (AAF)", "H_CrewHelmetHeli_I", 100, "hat"],
	...
	["Pilot Helmet (NATO)", "H_PilotHelmetFighter_B", 150, "hat"],
	["Pilot Helmet (CSAT)", "H_PilotHelmetFighter_O", 150, "hat"],
	["Pilot Helmet (AAF)", "H_PilotHelmetFighter_I", 150, "hat"],
	...
	["Bandanna (Coyote)", "H_Bandanna_cbr", 30, "hat"],
	["Bandanna (Camo)", "H_Bandanna_camo", 30, "hat"],
	["Bandanna (Gray)", "H_Bandanna_gry", 30, "hat"],
	["Bandanna (Khaki)", "H_Bandanna_khk", 30, "hat"],
	["Bandanna (MTP)", "H_Bandanna_mcamo", 30, "hat"],
	["Bandanna (Sage)", "H_Bandanna_sgg", 30, "hat"],
	["Bandanna (Surfer)", "H_Bandanna_surfer", 30, "hat"],
	...
	["Beanie (Dark blue)", "H_Watchcap_sgg", 30, "hat"],
	["Beanie (Dark brown)", "H_Watchcap_cbr", 30, "hat"],
	["Beanie (Dark khaki)", "H_Watchcap_khk", 30, "hat"],
	["Beanie (Dark green)", "H_Watchcap_camo", 30, "hat"],
	...
	["Booniehat (Tan)", "H_Booniehat_tan", 30, "hat"],
	["Booniehat (MTP)", "H_Booniehat_mcamo", 30, "hat"],
	["Booniehat (Digi)", "H_Booniehat_dgtl", 30, "hat"],
	...
	["Cap (Raven Security)", "H_Cap_blk_Raven", 30, "hat"],
	["Cap (SAS)", "H_Cap_khaki_specops_UK", 30, "hat"],
	["Cap (SF)", "H_Cap_tan_specops_US", 30, "hat"],
	["Cap (SPECOPS)", "H_Cap_brn_SPECOPS", 30, "hat"],
	["Shemag (White)", "H_ShemagOpen_khk", 50, "hat"],
	["Shemag (Brown)", "H_ShemagOpen_tan", 50, "hat"],
	["Shemag mask (Khaki)", "H_Shemag_khk", 50, "hat"],
	["Shemag mask (Olive)", "H_Shemag_olive", 50, "hat"],
...
[
	...
	["Recon Fatigues (MTP)", "U_B_CombatUniform_mcam_vest", 800, "uni"],
	["Recon Fatigues (Sage)", "U_B_SpecopsUniform_sgg", 800, "uni"],
	["CTRG Combat Uniform (UBACS)", "U_B_CTRG_1", 800, "uni"],
	["CTRG Combat Uniform (UBACS2)", "U_B_CTRG_2", 800, "uni"],
	["CTRG Combat Uniform (Tee)", "U_B_CTRG_3", 800, "uni"],
	["Recon Fatigues (Hex)", "U_O_SpecopsUniform_ocamo", 800, "uni"],
	["Fatigues (Urban)", "U_O_CombatUniform_oucamo", 800, "uni"],
	["Combat Fatigues Short (Digi)", "U_I_CombatUniform_shortsleeve", 800, "uni"],
	["Combat Fatigues Shirt (Digi)", "U_I_CombatUniform_tshirt", 800, "uni"],
	["Officer Fatigues (Hex)", "U_O_OfficerUniform_ocamo", 800, "uni"],
	["Officer Fatigues (Digi)", "U_I_OfficerUniform", 800, "uni"],
	["Pilot Coveralls (NATO)", "U_B_PilotCoveralls", 800, "uni"],
	["Pilot Coveralls (CSAT)", "U_O_PilotCoveralls", 800, "uni"],
	["Pilot Coveralls (AAF)", "U_I_pilotCoveralls", 800, "uni"],
	["Heli Pilot Coveralls (NATO)", "U_B_HeliPilotCoveralls", 800, "uni"],
	["Heli Pilot Coveralls (AAF)", "U_I_HeliPilotCoveralls", 800, "uni"],
	...
	["Racing Suit (Blue)", "U_C_Driver_1_blue", 500, "uni"],
	["Racing Suit (Green)", "U_C_Driver_1_green", 500, "uni"],
	["Racing Suit (Yellow)", "U_C_Driver_1_yellow", 500, "uni"],
	["Racing Suit (Orange)", "U_C_Driver_1_orange", 500, "uni"],
	["Racing Suit (Red)", "U_C_Driver_1_red", 500, "uni"],
	["Racing Suit (White)", "U_C_Driver_1_white", 500, "uni"],
	["Racing Suit (Fuel)", "U_C_Driver_1", 500, "uni"],
	["Racing Suit (Bluking)", "U_C_Driver_2", 5000, "uni"],
	["Racing Suit (Redstone)", "U_C_Driver_3", 500, "uni"],
...
[
	...
	["Carrier Lite (Green)", "V_PlateCarrier1_rgr", 150, "vest"],
	["Carrier Lite (Black)", "V_PlateCarrier1_blk", 150, "vest"],
	["Carrier Rig (Green)", "V_PlateCarrier3_rgr", 160, "vest"],
	["Carrier GL Rig (Green)", "V_PlateCarrierGL_rgr", 300, "vest"],
	...
	["GA Carrier Lite (Digi)", "V_PlateCarrierIA1_dgtl", 130, "vest"],
	["GA Carrier Rig (Digi)", "V_PlateCarrierIA2_dgtl", 130, "vest"],
	["GA Carrier GL Rig (Digi)", "V_PlateCarrierIAGL_dgtl", 280, "vest"],
	...
	["LBV Grenadier Harness (Gray)", "V_HarnessOGL_gry", 180, "vest"],
...
[
	...
	["Bergen (Sage)", "B_Bergen_sgg", 500, "backpack"],

	["Carryall (Khaki)", "B_Carryall_khk", 800, "backpack"],
	["Carryall (MTP)", "B_Carryall_mcamo", 800, "backpack"],
	["Carryall (Olive)", "B_Carryall_oli", 800, "backpack"],
	["Carryall (Urban)", "B_Carryall_oucamo", 800, "backpack"]
];

genItemArray = compileFinal str
[
	["Quadrotor UAV (NATO)", "B_UAV_01_backpack_F", 6000, "backpack"],
	["Quadrotor UAV (CSAT)", "O_UAV_01_backpack_F", 6000, "backpack"],
	["Quadrotor UAV (AAF)", "I_UAV_01_backpack_F", 6000, "backpack"],
	["UAV Terminal (NATO)", "B_UavTerminal", 8000, "gps"],
	["UAV Terminal (CSAT)", "O_UavTerminal", 8000, "gps"],
	["UAV Terminal (AAF)", "I_UavTerminal", 8000, "gps"],
	["GPS", "ItemGPS", 1000, "gps"],
	["First Aid Kit", "FirstAidKit", 500, "item"],
	["Medikit", "Medikit", 1500, "item"],
	["Toolkit", "ToolKit", 1500, "item"],
	["Mine Detector", "MineDetector", 1000, "item"],
	["NV Goggles", "NVGoggles", 800, "nvg"],
	["Diving Goggles", "G_Diving", 500, "gogg"],
	["Binoculars", "Binocular", 250, "binoc"],
	["Rangefinder", "Rangefinder", 800, "binoc"],
...
[
	...
	["Fuel Station", "Land_FuelStation_Feed_F", 250000, "object"]
];
...
[
	...
	["HEMTT Ammo", "B_Truck_01_ammo_F", 30000, "vehicle"],
...
[
	...
	["MSE-3 Marid", "O_APC_Wheeled_02_rcws_F", 22000, "vehicle"],
	["AMV-7 Marshall", "B_APC_Wheeled_01_cannon_F", 28000, "vehicle"],
...
[
	...
	//["LSD", "lsd", localize "STR_WL_ShopDescriptions_LSD", "client\icons\lsd.paa", 3500, 3000], // not needed
	//["Marijuana", "marijuana", localize "STR_WL_ShopDescriptions_Marijuana", "client\icons\marijuana.paa", 3500, 3000], // not needed
	//["Cocaine", "cocaine", localize "STR_WL_ShopDescriptions_Cocaine", "client\icons\cocaine.paa", 3500, 3000], // not needed
	//["Heroin", "heroin", localize "STR_WL_ShopDescriptions_Heroin", "client\icons\heroin.paa", 3500, 3000], // not needed
	["CCTV Camera", "cctv_camera", localize "STR_WL_ShopDescriptions_CCTV_Camera", "addons\cctv\icons\camcorder.paa", 800, 500],
	["CCTV Base Station", "cctv_base", localize "STR_WL_ShopDescriptions_CCTV_Base", "addons\cctv\icons\laptop.paa", 6000, 300],
	...
	//["Warchest", "warchest", localize "STR_WL_ShopDescriptions_Warchest", "client\icons\warchest.paa", 1000, 500], // not needed
	//["Boomerang Terminal", "boomerang_terminal", localize "STR_WL_ShopDescriptions_Boomerang_Terminal", "addons\boomerang\icons\terminal.paa", 850, 500], // not needed
	//["Boomerang Station", "boomerang_station", localize "STR_WL_ShopDescriptions_Boomerang_Station", "addons\boomerang\icons\antenna.paa", 850, 500] // not needed
];
