...
while {true} do
{
	...
	//_serverString = format ["<t color='#A0FFFFFF'>Server: YOUR NAME A3Wasteland</t>", call A3W_extDB_ServerID];
	//_serverString = format ["%1<br/><t color='#A0FFFFFF'>Teamspeak: YOURNAME.ts3dns.com<br/>Website: www.YOURNAME.tk</t>",_serverString];
	...
	{
		_tempString = format ["<t color='#A0FFFFFF'>YOUR NAME A3Wasteland %1<br/>www.YOURNAME.tk</t>", getText (configFile >> "CfgWorlds" >> worldName >> "description")];
		_yOffset = 0.28;
