...
["Check our Website and Teamspeak at:<br/>Website: http://www.YOURNAME.tk<br/>Teamspeak: YOURNAME.ts3dns.com<br/>", "Welcome to YOUR NAME A3Wasteland Stratis"] spawn BIS_fnc_guiMessage;
