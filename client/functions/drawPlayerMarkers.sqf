...
A3W_mapDraw_thread = [] spawn
{
	...
	waitUntil
	{
		...
		if (_showPlayers) then
		{
			...
			// no gps
			if ({_x in ["ItemGPS","B_UavTerminal","O_UavTerminal","I_UavTerminal"]} count assignedItems player > 0) then //Cael817, SNAFU, Make it necessary to have a GPS or UAV Terminal for markers to show.
			{//Cael817, SNAFU, Make it necessary to have a GPS or UAV Terminal for markers to show.
